...
// module.exports.uploadTestimonial = async (req, res) => {
//     try{
//         const { name, contactNumber, email, text } = req.body;

//         if (!name || !contactNumber || !email || !text ){
//             return res.json({ message: "All fields are required" });
//         }

//         const uploadedTestimonial = await LampTestimonial.create({ name , contactNumber, email, text })
...
//     try{
//         const testimonials = await LampTestimonial.find();
